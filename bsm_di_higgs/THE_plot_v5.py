...
# seperate canvas for colour bars
...
# maximum value of the colour bar used for acceptence
maxval=0.2
...
for quad in median_quadruplets:
    ...
    if quad[2] <= maxtauval and quad[3] > maxbval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_tau(quad[2]/maxtauval),alpha=1))
    elif quad[3] <= maxbval and quad[2] > maxtauval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_b(quad[3]/maxbval),alpha=1))
    elif quad[2] <= maxtauval and quad[3] <= maxbval:
...
ax.text(0.5,len(wanted_mhS_2D)-5, r'Median $\Delta$R(h to ττ)$\leq 0.5$', style='italic', fontsize=fontsize, color='black')
ax.add_patch(Rectangle((0.25,len(wanted_mhS_2D)-5.5), 8, 1.75, linewidth=1, edgecolor='black', facecolor=cmap_tau(0.5),alpha=0.5))
ax.text(0.5,len(wanted_mhS_2D)-3, r'Median $\Delta$R(h$_S$ to bb)$\leq 0.5$', style='italic', fontsize=fontsize, color='black')
ax.add_patch(Rectangle((0.25,len(wanted_mhS_2D)-3.5), 8, 1.75, linewidth=1, edgecolor='black', facecolor=cmap_b(0.5),alpha=0.5))       
ax.text(0.5,len(wanted_mhS_2D)-1, 'Acceptance < 0.2', style='italic', fontsize=fontsize, color='black')
ax.add_patch(Rectangle((0.25,len(wanted_mhS_2D)-1.5), 8, 1.75, linewidth=1, edgecolor='black', facecolor=cmap_eff(0.5),alpha=0.5))
...
norm_tau = mpl.colors.Normalize(vmin=0, vmax=maxtauval)
cb2 = mpl.colorbar.ColorbarBase(ax2, cmap=cmap_tau,
                                norm=norm_tau,
                                orientation='vertical')
cb2.set_label('Med. $\Delta$R(ττ)', rotation='vertical', fontsize=fontsize+5, position=(0,0.5))
cb2.ax.tick_params(labelsize=fontsize)
cb2.ax.locator_params(nbins=2)

norm_b = mpl.colors.Normalize(vmin=0, vmax=maxbval)
cb3 = mpl.colorbar.ColorbarBase(ax3, cmap=cmap_b,
                                norm=norm_b,
                                orientation='vertical')
cb3.set_label('Med. $\Delta$R(bb)', rotation='vertical', fontsize=fontsize+5, position=(0,0.5))
...
# object used: array of an array; positions in array of the variables for reference
#         [wan_mhS,MH_arr,    #0
#         b_pt_mean,b_pt_median,b_pt_std_dev, #2
#         t_pt_mean,t_pt_median,t_pt_std_dev, #5
#         HH_pt_mean,HH_pt_median,HH_pt_std_dev,  #8
...
# gs1 = GridSpecFromSubplotSpec(1, 1, subplot_spec=gs[0])
# gs2 = GridSpecFromSubplotSpec(1, 1, subplot_spec=gs[1],hspace=0.125)
# gs2 = GridSpecFromSubplotSpec(1, 1, subplot_spec=gs[1])
# plt.subplots_adjust(wspace=0.02)
...
for quad in median_quadruplets:
    ...
    mhposition=mhindex+1
    # ax.text(MHposition-0.25, mhposition+0.05, "{}".format(format(quad[2], ".2f")), style='italic',color=dRtcolor)
    ax.text(MHposition-0.45, mhposition-0.25, "{}".format(format(quad[3], ".2f")), style='italic',color=dRbcolor, fontsize=30)
    # if quad[2] <= maxtauval and quad[3] > maxbval:
    #     ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_tau(quad[2]/maxtauval),alpha=1))
    # elif quad[3] <= maxbval and quad[2] > maxtauval:
    #     ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_b(quad[3]/maxbval),alpha=1))
...
ax.text(0.5,len(wanted_mhS_2D)-1, r'Median $\Delta$R(h$_S$ to bb)', style='italic', fontsize=fontsize, color='black',
...
# norm_b = mpl.colors.Normalize(vmin=0, vmax=maxbval)
# cb3 = mpl.colorbar.ColorbarBase(ax1, cmap=cmap_b,
#                                 norm=norm_b,
#                                 orientation='vertical')
# cb3.set_label('median $\Delta$R(h$_S$ to bb)', rotation='vertical', fontsize=fontsize+5, position=(0,0.5))
# cb3.ax.tick_params(labelsize=fontsize)
# cb3.ax.locator_params(nbins=2)

# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_b_plot.pdf')
...
for quad in median_quadruplets:
    ...
    mhindex=np.where(wanted_mhS_2D==str(quad[0]))[0][0]
    mhposition=mhindex+1
    ax.text(MHposition-0.45, mhposition-0.25, "{}".format(format(quad[2], ".2f")), style='italic',color=dRtcolor, fontsize=30)
    # ax.text(MHposition-0.25, mhposition-0.35, "{}".format(format(quad[3], ".2f")), style='italic',color=dRbcolor)
    # if quad[2] <= maxtauval and quad[3] > maxbval:
    #     ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_tau(quad[2]/maxtauval),alpha=1))
    # elif quad[3] <= maxbval and quad[2] > maxtauval:
...
ax.text(0.5,len(wanted_mhS_2D)-1, r'Median $\Delta$R(h to ττ)', style='italic', fontsize=fontsize, color='black',
        bbox={'facecolor': cmap_tau(0.5), 'alpha': 0.5, 'pad': 10})
# ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(bb)', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': cmap_b(0.5), 'alpha': 0.5, 'pad': 10})
# ax.text(0.5,len(wanted_mhS_2D)-1, '$\epsilon_{cuts}$< 0.2', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': cmap_eff(0.5), 'alpha': 0.5, 'pad': 10})
...
# norm_tau = mpl.colors.Normalize(vmin=0, vmax=maxtauval)
# cb2 = mpl.colorbar.ColorbarBase(ax1, cmap=cmap_tau,
#                                 norm=norm_tau,
#                                 orientation='vertical')
# cb2.set_label('median $\Delta$R(h to ττ)', rotation='vertical', fontsize=fontsize+5, position=(0,0.5))
# cb2.ax.tick_params(labelsize=fontsize)
# cb2.ax.locator_params(nbins=2)
...
# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_tau_plot.pdf')
...
for quad in counter_tuple:
    ...
    ax.text(MHposition-0.45, mhposition-0.25, "{}".format(format(com_eff, ".2f")), style='italic',color='r', fontsize=30)
    # ax.text(MHposition-0.4, mhposition-0.35, "{equa}".format(nFound=format( found,".0f") , nLep = format(fulllep_found ,".0f"), equa =format(number_events ,".0f")), style='italic',color=dRtcolor,)
    ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor='white',alpha=1))
    # if com_eff <= maxval:
    #     ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_eff(com_eff/maxval),alpha=1))
...
# ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(ττ)$< 0.5$', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': cmap_tau(0.5), 'alpha': 0.5, 'pad': 10})
# ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(bb)', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': cmap_b(0.5), 'alpha': 0.5, 'pad': 10})
ax.text(0.5,len(wanted_mhS_2D)-1, 'Acceptance', style='italic', fontsize=fontsize, color='black',
        bbox={'facecolor': cmap_eff(0.5), 'alpha': 0.5, 'pad': 10})
...
# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_acc_plot.pdf')
...
for quad in median_quadruplets:
    ...
    mhindex=np.where(wanted_mhS_2D==str(quad[0]))[0][0]
    mhposition=mhindex+1
    # ax.text(MHposition-0.45, mhposition-0.25, "{}".format(format(quad[2], ".2f")), style='italic',color='black', fontsize=30)
    # ax.text(MHposition-0.25, mhposition-0.35, "{}".format(format(quad[3], ".2f")), style='italic',color=dRbcolor)
    if quad[2] <= maxtauval and quad[2] >= mintauval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_tau((quad[2]-mintauval)/(maxtauval-mintauval)),alpha=1))
    # elif quad[3] <= maxbval and quad[2] > maxtauval:
    #     ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap_b(quad[3]/maxbval),alpha=1))
    # elif quad[2] <= maxtauval and quad[3] <= maxbval:
    #     ax.add_patch(Polygon([[MHposition-0.5,mhposition-0.5],[MHposition-0.5,mhposition+0.5],[MHposition+0.5,mhposition+0.5]], closed=True, linewidth=1, edgecolor='black', facecolor=cmap_tau(quad[2]/0.5),alpha=1))
...
# ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(bb)', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': cmap_b(0.5), 'alpha': 0.5, 'pad': 10})
# ax.text(0.5,len(wanted_mhS_2D)-1, r'median $\Delta$R(hh$_S$)', style='italic', fontsize=fontsize, color='black',
#         bbox={'facecolor': dRtcolor, 'alpha': 0.5, 'pad': 10})
...
norm_tau = mpl.colors.Normalize(vmin=mintauval, vmax=maxtauval)
cb2 = mpl.colorbar.ColorbarBase(ax1, cmap=cmap_tau,
                                norm=norm_tau,
                                orientation='vertical')
cb2.set_label('Median $\Delta$R(H to hh$_S$)', rotation='vertical', fontsize=fontsize+5, position=(0,0.5))
cb2.ax.tick_params(labelsize=fontsize)
cb2.ax.locator_params(nbins=2)
...
# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_HdR_plot.pdf')