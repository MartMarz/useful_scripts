...
#    nom.SetMarkerColor(2)
    ...
    legend = ROOT.TLegend(0.6, 0.0, 0.95, 0.35)
...
tauRecoCuts = "nVetoMu==1 && nEle==0 && nPairs_corr==1 && Pair_Charge_Valid_corr==1"
bRecoCuts = "N_taggedJets_corr_nom >=1 && N_allJets_corr_nom>=2"
...
# sanity(rfile, opts.outDir,variable="GEN_bPair_dR",cuts=bGenCuts,legend="GEN cuts",XAxisLabel="GEN #DeltaR(bb)",suffix="")
# sanity(rfile, opts.outDir,variable="GEN_TauPair_dR",cuts=tauGenCuts,legend="GEN cuts",XAxisLabel="GEN #DeltaR(#tau#tau)",suffix="")
...
# drawshifts(rfile, opts.outDir,variable1="GEN_RECO_dR_b1",cuts1=bGenCuts+"&&"+bRecoCuts,cuts2=bGenCuts+"&&"+bRecoCuts+"&&"+"N_TagsM_corr_nom>1",mode="compare cuts",legend1="nbJets #geq 1",legend2="nJets #geq 2",XAxisLabel="min #DeltaR(GEN b, RECO Jet)",efficiency=True,min=0,max=4,nbin=80,suffix="2tags")
# drawshifts(rfile, opts.outDir,variable1="GEN_RECO_dR_b2",cuts1=bGenCuts+"&&"+bRecoCuts,cuts2=bGenCuts+"&&"+bRecoCuts+"&&"+"N_TagsM_corr_nom>1",mode="compare cuts",legend1="nbJets #geq 1",legend2="nJets #geq 2",XAxisLabel="remaining pair #DeltaR(GEN b, RECO Jet)",efficiency=True,min=0,max=4,nbin=80,suffix="2tags")
...
drawshifts(rfile, opts.outDir,variable1="GEN_TauPair_dR",cuts1=tauGenCuts,cuts2=tauGenCuts+"&&"+tauRecoCuts,cuts3=tauGenCuts+"&&"+tauRecoCuts+"&&"+"(GEN_RECO_dR_tau<0.3 && GEN_RECO_dR_muon<0.3)",mode="compare three",legend1=r"N_{GEN}",legend2=r"N_{REC}",legend3=r"N_{REC} matched #DeltaR < 0.3",YAxisLabel="#frac{RECO}{GEN} / #frac{#DeltaR(matching)}{GEN}",XAxisLabel="GEN #DeltaR(#tau#tau)",efficiency=True,min=0,max=0.8,nbin=40,suffix="three")

drawshifts(rfile, opts.outDir,variable1="GEN_bPair_dR",cuts1=bGenCuts,cuts2=bGenCuts+"&&"+bRecoCuts,cuts3=bGenCuts+"&&"+bRecoCuts+"&&"+"(GEN_RECO_dR_b1<0.3 && GEN_RECO_dR_b2<0.3)",mode="compare three",legend1=r"N_{GEN}",legend2=r"N_{REC}",legend3=r"N_{REC} matched #DeltaR < 0.3",YAxisLabel="#frac{RECO}{GEN} / #frac{#DeltaR(matching)}{GEN}",XAxisLabel="GEN #DeltaR(bb)",efficiency=True,min=0,max=0.8,nbin=40,suffix="three")

drawshifts(rfile, opts.outDir,variable1="GEN_bPair_dR",cuts1=bGenCuts,cuts2=bGenCuts+"&&"+bRecoCuts+"&& N_taggedJets_corr_nom>=2",cuts3=bGenCuts+"&&"+bRecoCuts+"&&"+"(GEN_RECO_dR_b1<0.3 && GEN_RECO_dR_b2<0.3)"+"&& N_taggedJets_corr_nom>=2",mode="compare three",legend1=r"N_{GEN}",legend2=r"N_{REC;Nbjets #geq 2}",legend3=r"N_{REC} matched #DeltaR < 0.3",YAxisLabel="#frac{RECO}{GEN} / #frac{#DeltaR(matching)}{GEN}",XAxisLabel="GEN #DeltaR(bb)",efficiency=True,min=0,max=0.8,nbin=40,suffix="three_2tags")
