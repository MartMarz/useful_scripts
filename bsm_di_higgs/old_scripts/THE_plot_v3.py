...
for quad in counter_tuple:
    ...
    ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor='white'))
    if com_eff <= maxval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap(com_eff/maxval),alpha=1))
...
for quad in median_quadruplets:
    ...
    if quad[2] <= 0.5 and quad[3] > 0.4:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=pTtcolor,alpha=0.5))
    elif quad[2] > 0.5 and quad[3] <= 0.4:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=pTbcolor,alpha=0.5))
    elif quad[2] <= 0.5 and quad[3] <= 0.4:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor='purple',alpha=0.5))
...
ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(h; tau tau)$< 0.5$', style='italic', fontsize=fontsize, color='black',
        bbox={'facecolor': pTtcolor, 'alpha': 0.5, 'pad': 10})
ax.text(0.5,len(wanted_mhS_2D)-3, 'median $\Delta$R($h_S$; bb)$< 0.4$', style='italic', fontsize=fontsize, color='black',
        bbox={'facecolor': pTbcolor, 'alpha': 0.5, 'pad': 10})
...
cb1.set_label('$\epsilon_{cuts}$', rotation='vertical', fontsize=fontsize+5, position=(-1,0.6) )
...
for quad in counter_tuple:
    ...
    ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor='white'))
    if b_eff <= maxval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap(b_eff/maxval),alpha=1))
...
cb1 = mpl.colorbar.ColorbarBase(ax1, cmap=cmap,
                                norm=norm,
                                orientation='vertical')
cb1.set_label('$\epsilon_{b cuts}$', rotation='vertical', fontsize=fontsize+5, position=(-1,0.6) )
cb1.ax.tick_params(labelsize=fontsize)
cb1.ax.locator_params(nbins=4)

# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_b_eff.pdf')
...
for quad in counter_tuple:
    ...
    ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor='white'))
    if t_eff <= maxval:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='black', facecolor=cmap(t_eff/maxval),alpha=1))
...
cb1 = mpl.colorbar.ColorbarBase(ax1, cmap=cmap,
                                norm=norm,
                                orientation='vertical')
cb1.set_label('$\epsilon_{tau cuts}$', rotation='vertical', fontsize=fontsize+5, position=(-1,0.6) )
cb1.ax.tick_params(labelsize=fontsize)
cb1.ax.locator_params(nbins=4)

# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_t_eff.pdf')
...
# plt.show()
# fig.tight_layout()
plt.savefig(check+'/2D_comb_eff.pdf')