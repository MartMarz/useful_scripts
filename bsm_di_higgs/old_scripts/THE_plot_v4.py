...
gs1 = GridSpecFromSubplotSpec(2, 1, height_ratios=[height, ratio], subplot_spec=gs[0],hspace=0.25)
gs3 = GridSpecFromSubplotSpec(2, 1, height_ratios=[ratio, height], subplot_spec=gs1[0],hspace=0.02)
gs4 = GridSpecFromSubplotSpec(1, 1, subplot_spec=gs1[1])
gs2 = GridSpecFromSubplotSpec(1, 1, subplot_spec=gs[1])
# plt.subplots_adjust(wspace=0.02)
ax = fig.add_subplot(gs3[1])
ax1 = fig.add_subplot(gs2[0])
ax2 = fig.add_subplot(gs3[0])
ax3 = fig.add_subplot(gs4[0])
...
ax.text(0.5,len(wanted_mhS_2D)-1, 'median $\Delta$R(tau tau)$< 0.5$', style='italic', fontsize=fontsize, color='black',
...
ax.text(0.5,len(wanted_mhS_2D)-5, '$\epsilon_{cuts}$< 0.2', style='italic', fontsize=fontsize, color='black',
...
cb1.set_label('$\epsilon_{cuts}$', rotation='vertical', fontsize=fontsize+20, position=(0,0.6) , labelpad=-5)
...
cb2.set_label('$\Delta$R(h to tautau)', rotation='horizontal', fontsize=fontsize+10, position=(0.5,0), labelpad=15)
...
cb3 = mpl.colorbar.ColorbarBase(ax3, cmap=cmap_b,
                                norm=norm_b,
                                orientation='horizontal')
cb3.set_label('$\Delta$R(h$_S$ to bb)', rotation='horizontal', fontsize=fontsize+10, position=(0.5,0) )
