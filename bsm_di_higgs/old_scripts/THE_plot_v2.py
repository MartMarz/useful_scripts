...
for quad in counter_tuple:
    ...
    ax.text(MHposition-0.25, mhposition+0.05, "{}".format(format(t_eff, ".2f")), style='italic',color=dRtcolor)
    ax.text(MHposition-0.25, mhposition-0.35, "{}".format(format(b_eff, ".2f")), style='italic',color=dRbcolor)
    if b_eff <= 0.2 and t_eff > 0.2:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor=pTbcolor, facecolor=pTbcolor,alpha=0.25))
    elif b_eff > 0.2 and t_eff <= 0.2:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor=pTtcolor, facecolor=pTtcolor,alpha=0.25))
    elif b_eff <= 0.2 and t_eff <= 0.2:
        ax.add_patch(Rectangle((MHposition-0.5, mhposition-0.5), 1, 1, linewidth=1, edgecolor='purple', facecolor='purple',alpha=0.25))
...
ax.text(0.5,len(wanted_mhS_2D)-1, 'tau$_{eff} < 0.2$', style='italic', fontsize=fontsize, color=dRtcolor,
        bbox={'facecolor': pTtcolor, 'alpha': 0.15, 'pad': 10})
ax.text(0.5,len(wanted_mhS_2D)-3, 'b$_{eff} < 0.2$', style='italic', fontsize=fontsize, color=dRbcolor,
        bbox={'facecolor': pTbcolor, 'alpha': 0.15, 'pad': 10})
ax.text(0.5,len(wanted_mhS_2D)-5, '$both$', style='italic', fontsize=fontsize,
        bbox={'facecolor': 'purple', 'alpha': 0.15, 'pad': 10})
...
ax.text(0.5,len(wanted_mhS_2D)-1, 'comb$_{eff} < 0.2$', style='italic', fontsize=fontsize, color='black',
        bbox={'facecolor': 'red', 'alpha': 0.15, 'pad': 10})
ax.text(0.5,len(wanted_mhS_2D)-5, "N-N_{fulllep}", style='italic', fontsize=fontsize, color=dRtcolor)
ax.text(0.5,len(wanted_mhS_2D)-3, "N={}".format(format(found,".0f")), style='italic', fontsize=fontsize, color='black')
